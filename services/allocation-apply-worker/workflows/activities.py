...
async def _run_script(job_id: str, board: str, user_id: str,
    ...
    return {"stdout": out[-2000:], "stderr": err[-2000:], "code": 0}


@activity.defn
async def autofill_activity(job_id: str, board: str, user_id: str) -> dict:
    return await _run_script(job_id, board, user_id)


@activity.defn
async def captcha_activity(job_id: str, board: str, user_id: str, code: str) -> dict:
    return await _run_script(job_id, board, user_id, extra_env={"SECURITY_CODE": code})
